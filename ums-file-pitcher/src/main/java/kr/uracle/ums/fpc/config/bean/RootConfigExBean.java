...
public class RootConfigExBean {		
	...
	private Map<String, PitcherExConfigBean> PITCHERS = new HashMap<String, PitcherExConfigBean>(5);
	...
	public Map<String, PitcherExConfigBean> getPITCHERS() { return PITCHERS; }
	public void setPITCHERS(Map<String, PitcherExConfigBean> PITCHERS) { this.PITCHERS = PITCHERS; }
